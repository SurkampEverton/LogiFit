...
- [`docs/rules.md`](docs/rules.md) — **40 regras duras** (arquiteturais, processo, código, i18n, IA, LGPD, pesquisa global, responsividade, arquitetura IA, tratamento de erros, escalabilidade do banco, segurança em profundidade)
...
Lista completa em [`docs/rules.md`](docs/rules.md) (40 regras duras).
