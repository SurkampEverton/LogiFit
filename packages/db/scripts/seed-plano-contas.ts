...
const CHART_ROWS: ChartSeedRow[] = [
  ...
  { code: '1.1.02', name: 'Bancos Conta Movimento', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  { code: '1.1.03', name: 'Aplicações Financeiras Curto Prazo', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  { code: '1.1.04', name: 'Contas a Receber Clientes', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  { code: '1.1.05', name: 'Cartão de Crédito a Receber', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  { code: '1.1.06', name: 'Adiantamentos a Fornecedores', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  { code: '1.1.07', name: 'Estoque — Insumos e Suplementos', kind: 'ativo', isLeaf: true, parentCode: '1.1' },
  ...
  { code: '1.2.01', name: 'Imobilizado — Equipamentos', kind: 'ativo', isLeaf: true, parentCode: '1.2' },
  { code: '1.2.02', name: 'Imobilizado — Móveis e Utensílios', kind: 'ativo', isLeaf: true, parentCode: '1.2' },
  { code: '1.2.03', name: 'Imobilizado — Veículos', kind: 'ativo', isLeaf: true, parentCode: '1.2' },
  { code: '1.2.04', name: 'Software / Sistemas', kind: 'ativo', isLeaf: true, parentCode: '1.2' },
  { code: '1.2.05', name: '(-) Depreciação Acumulada', kind: 'ativo', isLeaf: true, parentCode: '1.2' },
  ...
  { code: '2.1.01', name: 'Fornecedores a Pagar', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.1.02', name: 'Empréstimos Curto Prazo', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.1.03', name: 'Salários e Encargos a Pagar', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.1.04', name: 'Impostos a Recolher', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.1.05', name: 'Cartões de Crédito a Pagar', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.1.06', name: 'Adiantamentos de Clientes', kind: 'passivo', isLeaf: true, parentCode: '2.1' },
  { code: '2.2', name: 'Passivo Não Circulante', kind: 'passivo', isLeaf: false, parentCode: '2' },
  { code: '2.2.01', name: 'Financiamento Longo Prazo', kind: 'passivo', isLeaf: true, parentCode: '2.2' },
  ...
  { code: '2.3.02', name: 'Lucros / Prejuízos Acumulados', kind: 'passivo', isLeaf: true, parentCode: '2.3' },
  ...
  { code: '3.1.01', name: 'Mensalidade Academia', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.02', name: 'Personal Trainer', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.03', name: 'Aulas Avulsas / Coletivas', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.04', name: 'Avaliações Físicas', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.05', name: 'Atendimento Fisioterapia', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.06', name: 'Consultas Nutricionais', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.07', name: 'Venda Suplementos', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.08', name: 'Venda Vestuário / Acessórios', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.1.09', name: 'Convênios e Planos Empresariais', kind: 'receita', isLeaf: true, parentCode: '3.1' },
  { code: '3.2', name: 'Receita Não Operacional', kind: 'receita', isLeaf: false, parentCode: '3' },
  { code: '3.2.01', name: 'Aluguel de Espaços / Cessão', kind: 'receita', isLeaf: true, parentCode: '3.2' },
  { code: '3.2.02', name: 'Juros e Rendimentos Aplicações', kind: 'receita', isLeaf: true, parentCode: '3.2' },
  { code: '3.2.03', name: 'Reembolsos e Devoluções Recebidas', kind: 'receita', isLeaf: true, parentCode: '3.2' },
  ...
  { code: '4.1.04', name: '13º / Férias / Encargos', kind: 'despesa', isLeaf: true, parentCode: '4.1' },
  { code: '4.1.05', name: 'Pró-labore de Sócios', kind: 'despesa', isLeaf: true, parentCode: '4.1' },
  { code: '4.1.06', name: 'Comissões Profissionais', kind: 'despesa', isLeaf: true, parentCode: '4.1' },
  { code: '4.1.07', name: 'Benefícios (VR / VA / Plano Saúde)', kind: 'despesa', isLeaf: true, parentCode: '4.1' },
  { code: '4.2', name: 'Despesas Administrativas', kind: 'despesa', isLeaf: false, parentCode: '4' },
  ...
  { code: '4.2.05', name: 'Internet / Telefonia', kind: 'despesa', isLeaf: true, parentCode: '4.2' },
  { code: '4.2.06', name: 'Material de Escritório / Limpeza', kind: 'despesa', isLeaf: true, parentCode: '4.2' },
  ...
  { code: '4.3.01', name: 'Marketing Digital (Ads / Social)', kind: 'despesa', isLeaf: true, parentCode: '4.3' },
  { code: '4.3.02', name: 'Material Gráfico / Brindes', kind: 'despesa', isLeaf: true, parentCode: '4.3' },
  { code: '4.3.03', name: 'Eventos / Patrocínios', kind: 'despesa', isLeaf: true, parentCode: '4.3' },
  { code: '4.3.04', name: 'Comissão Indicação / Referral', kind: 'despesa', isLeaf: true, parentCode: '4.3' },
  { code: '4.4', name: 'Despesas Financeiras', kind: 'despesa', isLeaf: false, parentCode: '4' },
  { code: '4.4.01', name: 'Juros e Multas Pagos', kind: 'despesa', isLeaf: true, parentCode: '4.4' },
  ...
  { code: '5.1.01', name: 'Materiais Descartáveis (luvas / faixas / fitas)', kind: 'custo', isLeaf: true, parentCode: '5.1' },
  { code: '5.1.02', name: 'Suplementos para Revenda (CMV)', kind: 'custo', isLeaf: true, parentCode: '5.1' },
  { code: '5.1.03', name: 'Manutenção de Equipamentos', kind: 'custo', isLeaf: true, parentCode: '5.1' },
  { code: '5.1.04', name: 'Calibração / Aferição', kind: 'custo', isLeaf: true, parentCode: '5.1' },
  { code: '5.1.05', name: 'Vestuário Equipe / Uniformes', kind: 'custo', isLeaf: true, parentCode: '5.1' },
]
...
async function main() {
  ...
  console.log(`→ seeding plano-contas + approval_rules ${DATABASE_URL.replace(/:[^:@]+@/, ':***@')}`)
