...
import { Pool } from 'pg'
import { insurancePlans, tussCatalog, tussCatalogImports } from '../src/schema/index.js'
...
const TUSS: TussSeed[] = [
  ...
  {
    code: '10101039',
    description: 'Consulta em domicílio',
    category: 'procedimento',
    specialties: ['medicina'],
  },
  {
  ...
  {
    code: '20104081',
    description: 'Sessão de fisioterapia em grupo',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  {
    code: '20104090',
    description: 'Atendimento fisioterapêutico hospitalar',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  // Nutrição
  ...
  {
    code: '50000489',
    description: 'Acompanhamento nutricional individual',
    category: 'procedimento',
    specialties: ['nutricao'],
  },
  // Enfermagem
  {
    code: '40101010',
    description: 'Visita de enfermagem hospitalar',
    category: 'procedimento',
  ...
  {
    code: '20104111',
    description: 'Reeducação Postural Global (RPG)',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  ...
  {
    code: '40901327',
    description: 'Espirometria simples',
    category: 'procedimento',
    specialties: ['medicina', 'fisioterapia'],
  },
  // Avaliação
  {
    code: '50000071',
  ...
  {
    code: '20104278',
    description: 'Aplicação de imobilização gessada (membro inferior)',
    category: 'procedimento',
    specialties: ['medicina', 'fisioterapia'],
  },
  // OPME comum
  {
    code: '70000118',
    description: 'Joelheira articulada',
    category: 'opme',
    specialties: ['fisioterapia', 'medicina'],
  },
  {
    code: '70000142',
    description: 'Tornozeleira elástica',
    category: 'opme',
    specialties: ['fisioterapia', 'medicina'],
  },
  {
    code: '70000169',
    description: 'Colete lombar abdominal',
    category: 'opme',
    specialties: ['fisioterapia', 'medicina'],
  },
  ...
  {
    code: '90150019',
    description: 'Diclofenaco sódico gel 1%',
    category: 'medicamento',
    specialties: ['fisioterapia'],
  },
  {
    code: '90150035',
    description: 'Tribedoxina (Vitamina B1+B6+B12) injetável',
    category: 'medicamento',
    specialties: ['medicina'],
  },
  {
    ...
    category: 'medicamento',
    specialties: ['medicina', 'enfermagem'],
  },
  // Taxas
  {
    code: '60010014',
    description: 'Taxa de sala para procedimento ambulatorial',
    category: 'taxa_diaria',
    specialties: [],
  },
  {
    code: '60010030',
    description: 'Taxa de equipamento (eletroterapia)',
    category: 'taxa_diaria',
    specialties: ['fisioterapia'],
  },
  ...
  {
    code: '80010019',
    description: 'Oxigenoterapia (por hora)',
    category: 'gasoterapia',
    specialties: ['fisioterapia', 'medicina'],
  },
  // Sessão grupo / Pilates clínico
  {
    code: '20104120',
    description: 'Pilates terapêutico em grupo (até 5 pacientes)',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  {
    code: '20104138',
    description: 'Hidroterapia em piscina aquecida',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  // Outros comuns
  {
    code: '20104154',
    description: 'Massoterapia / liberação miofascial',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  {
    code: '20104162',
    description: 'Crochetagem mioaponeurótica',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  {
    code: '20104170',
    description: 'Bandagem terapêutica (Kinesio Taping)',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
  {
    code: '20104189',
    description: 'Terapia manual ortopédica',
    category: 'procedimento',
    specialties: ['fisioterapia'],
  },
]
