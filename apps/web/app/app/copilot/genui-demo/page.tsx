    ...
    <div className="ev-stack" style={{ padding: 'var(--ev-space-lg)' }}>
      ...
      >
        ...
        <span style={{ color: 'var(--ev-text-muted)' }}>
          Sprint 28 · ADR 0085 — fecha Fase 2
        </span>
      </header>

      <section className="ev-card" style={{ padding: 'var(--ev-space-md)' }}>
        <p style={{ marginTop: 0, color: 'var(--ev-text-muted)' }}>
          Pergunte algo clínico. A resposta vai vir <strong>misturando texto e componentes
          ricos</strong> (card de paciente, gráfico de evolução, sugestão de CID, recomendação
          de exercícios, comparação de medições, blocos de relatório).
        </p>
