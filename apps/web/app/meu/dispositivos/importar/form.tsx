...
export function ImportCsvForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="ev-portal-form">
      ...
      {err ? (
        <div className="ev-portal-callout ev-portal-callout--danger">{err}</div>
      ) : null}
      ...
      {result ? (
        <div className="ev-portal-callout ev-portal-callout--success">
          ...
          <p>
            ✓ {result.inserted} leituras inseridas ({result.validReadings} válidas total —
            o resto era duplicata)
          </p>
