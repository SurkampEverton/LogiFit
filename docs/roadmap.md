...
| 6 | [04](sprints/04-geral-financeiro-asaas.md) | Financeiro Asaas (planos, contratos, cobranças, trancamento, DRE básico) | **doing** | 2026-05-13 | — | 50 | Faixas A + B entregues (6 schemas + 14 RLS + 9 Vitest + 6 Server Actions + webhook handler /api/webhooks/asaas + envelope encryption + 9 unit tests); Faixas C/D restantes (UI financeiro + widget member + job D-5 + ADRs 0013+0014) | — |
