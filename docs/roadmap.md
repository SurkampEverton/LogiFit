...
| 7 | [05](sprints/05-geral-ofertas-comerciais.md) | Ofertas comerciais (promoções, pacotes, referrals, cashback) | **doing** | 2026-05-13 | — | 75 | Faixas A+B+C entregues (7 schemas + 20 RLS + 10 tests + 7 Server Actions + canApply validator + UI promoções + widget créditos em member + ADR 0020); Faixa D restante (job expiração créditos + seed canônico) | — |
