...
| 9 | [07](sprints/07-geral-dashboard.md) | Dashboard "Equilíbrio Vital" + cross-alert dispatcher | **doing** | 2026-05-13 | — | 40 | Faixa A entregue (Dashboard `/app` real com 7 KPIs cross-module em paralelo: alunos/contratos/MRR/overdue/receita 30d/agenda hoje/agenda 7d + 4 atalhos rápidos + alert_subscribers schema stub); Faixas B/C/D restantes (role-aware dashboards `/app/dashboard/{role}` + Command Palette Ctrl+K + ADR 0016 tokens + UI super-admin/database + materialized views) | — |
