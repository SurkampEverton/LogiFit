...
| 8 | [06](sprints/06-geral-copilot-base.md) | **Assistente IA universal base (3 camadas Help/Insight/Action + tool registry distribuído + 7 personas + FAB global + cotas alinhadas a planos — ADR 0064 + 0075)** | **doing** | 2026-05-13 | — | 10 | Faixa A entregue (10 schemas IA: providers/models/task_routing/tenant_usage/audit_log/sessions/messages/action_proposals/tools_registry + 4 enums + 16 RLS policies + seed 5 providers); Faixas B/C/D restantes (Vercel AI SDK wrapper + RAG + UI FAB + cotas enforcement + ADR 0064/0075 publicados) | — |
...
| 11 | [09](sprints/09-geral-engajamento.md) | Engajamento v1 (conquistas + brindes + metas) | **doing** | 2026-05-13 | — | 25 | Faixa A entregue (6 schemas: achievements + member_achievements PK composta idempotente + rewards_catalog + reward_grants state machine + goals + goal_measurements + 5 enums + 16 RLS policies + check stock_qty non-negative); Faixas B/C/D restantes (DSL evaluator rule jsonb, dispatcher cross-alert, Server Actions, UI /app/engajamento/*, widgets conquistas/metas em member detail, seed canônico, ADR 0021) | — |
