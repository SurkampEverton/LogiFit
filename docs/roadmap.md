...
| 10 | [08](sprints/08-academia-controle-acesso.md) | Controle de acesso Academia (QR HMAC + facial opcional + catraca + bloqueio) | **doing** | 2026-05-13 | — | 25 | Faixa A entregue (4 schemas: access_devices + access_secrets + access_events + access_blocks + 3 enums + 11 RLS policies; facial recognition adiado pra Sprint 09+ por depender ADR 0018 hardware + RIPD biometria); Faixas B/C/D restantes (HMAC QR gen/validate + API checkin + UI feed ao vivo + ADRs 0017+0018) | — |
