...
| 7 | [05](sprints/05-geral-ofertas-comerciais.md) | Ofertas comerciais (promoções, pacotes, referrals, cashback) | **doing** | 2026-05-13 | — | 25 | Faixa A entregue (7 schemas + 20 RLS policies + plans.kind enum text+check + 10 Vitest tests + check constraints completos); Faixas B/C/D restantes (Server Actions + UI + integração com createAppointment pra consumir créditos) | — |
