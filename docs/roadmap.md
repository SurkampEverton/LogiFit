...
| 5 | [03](sprints/03-geral-agenda-universal.md) | Agenda universal + modalidades Academia | **doing** | 2026-05-12 | — | 75 | Faixas A + B + C entregues (schemas + RLS + EXCLUDE + 8 Server Actions + 5 rotas UI completas — lista 7d, novo, detalhe, recursos, novo recurso); Faixa C avançada (canvas semanal + drag&drop) e Faixa D (Realtime LISTEN/NOTIFY + RRULE expand + widget agenda em member detail + ADR 0012) restantes | — |
