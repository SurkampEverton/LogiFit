...
| 5 | [03](sprints/03-geral-agenda-universal.md) | Agenda universal + modalidades Academia | **doing** | 2026-05-12 | — | 90 | Faixas A + B + C + D parcial entregues (schemas + RLS + EXCLUDE + 9 Server Actions + 5 rotas UI + ADR 0012 + `expandRecurring()` rrule.js + widget agenda em member detail); restantes só Realtime LISTEN/NOTIFY + canvas semanal drag&drop (10% finais) | — |
