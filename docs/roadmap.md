...
| 12 | [10](sprints/10-geral-funil-vendas.md) | Funil de vendas (leads, aula experimental, propostas, conversão) | doing | 2026-05-13 | — | 25 | Faixa A done: 5 schemas (lead_stages/leads/lead_events/trial_classes/proposals) + 4 enums + RLS tenant-scoped + 8 tests (isolation, check constraints, lead_events append-only). Faltam Faixas B/C/D: Server Actions (createLead/moveLeadToStage/convertLeadToMember atomic) + UI kanban board + UI tabular lista + UI conversão wizard + ADR 0022 publicado | — |
