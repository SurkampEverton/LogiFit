...
| 5 | [03](sprints/03-geral-agenda-universal.md) | Agenda universal + modalidades Academia | **doing** | 2026-05-12 | — | 50 | Faixas A + B entregues (schemas + RLS + EXCLUDE + 7 Server Actions wrapped); Faixa C inicial entregue (`/app/agenda` lista 7 dias); Faixa C avançada (canvas semanal + drag&drop) e Faixa D (Realtime + RRULE expand + widget agenda em member detail) restantes | — |
