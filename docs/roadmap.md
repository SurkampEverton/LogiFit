...
| 6 | [04](sprints/04-geral-financeiro-asaas.md) | Financeiro Asaas (planos, contratos, cobranças, trancamento, DRE básico) | **doing** | 2026-05-13 | — | 25 | Faixa A entregue (6 schemas + 14 RLS policies + check constraints + 9 Vitest tests); Faixas B/C/D restantes (Server Actions + webhook handler + UI + cobranças automáticas D-5) | — |
