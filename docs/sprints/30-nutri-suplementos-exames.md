...
- [ ] ADR 0082 publicado
- [ ] **RIPD [`docs/compliance/ripd/v1.0-exames-laboratoriais.md`](../compliance/ripd/v1.0-exames-laboratoriais.md)** publicado e assinado pelo DPO antes do feature flag ir a produção (regra 29 + ADR 0054); cobre `lab_results` + `supplement_prescriptions` + interações; retenção 20a (Lei 13.787 — exames laboratoriais). RIPD compartilhado com Sprint 33 (Pipeline Exames).
