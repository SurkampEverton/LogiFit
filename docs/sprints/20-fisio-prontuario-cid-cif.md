...
- **[ADR 0028](../decisions/0028-cid-cif-catalogos-globais.md)** (Proposed — 2026-05-17) — CID-11 + CIF como catálogos globais versionados; update anual via LogiFit admin (seed de release), não editáveis por tenant. Vinculação via `consulta_cids` (M:N) e `consulta_cifs`.
