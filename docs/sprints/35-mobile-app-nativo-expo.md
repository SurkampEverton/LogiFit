...
- ADR 0089+ (a alocar quando sprint começar) — Auth no app: BetterAuth same JWT vs OAuth nativo (Apple Sign-in mandatório); Política de versionamento + EOL de versões antigas. Numeração ≥0089 (0080-0088 já consumidos pelas Sprints 23/24/26/27/28/29/30/31 — auditorias 12, 14 e 15).
