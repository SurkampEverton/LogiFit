...
| **Planos comerciais LogiFit (ADR 0066)** | 3 planos: Starter R$ 149 · Pro R$ 399 · Enterprise sob consulta. Trial 14d sem cartão. Cobrança Asaas próprio + NFS-e via Focus NFe. Régua de inadimplência D+0 → D+21 read-only → D+45 suspenso → D+135 anonimização. Upgrade pró-rata imediato; downgrade fim do ciclo. | todas | 01a + 04 + 36 | todo |
