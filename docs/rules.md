...
Regras duras e inquebráveis. Divididas em 3 blocos + regras transversais (multi-empresa, i18n, IA, LGPD, pesquisa global, responsividade, arquitetura IA, tratamento de erros, escalabilidade do banco, **segurança em profundidade**). Violação = CI vermelho, revert, ou sprint não fecha.
